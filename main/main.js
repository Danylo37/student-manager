...
function registerIpcHandlers() {
  ...
  ipcMain.handle('db:update-balance', (_, studentId, amount) => db.updateStudentBalance(studentId, amount));
  ...
  ipcMain.handle('db:add-lesson', (_, data) => db.addLesson(data.studentId, data.datetime, data.isPaid));
